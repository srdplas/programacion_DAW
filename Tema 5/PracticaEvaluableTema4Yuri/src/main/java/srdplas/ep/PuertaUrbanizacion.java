		...
		if (!tarjetasPermitidas.isEmpty()) {
			...
			while (iterador.hasNext()) {
				...
				if (lectura == identificador) {
					...
					// DEBEMOS BORRAR LA TARJETA PERMITIDA BORRADA DE TARJETADENTRO, PORQUE PODRÍA
...
//		}
	...
	public void intentoDeEntrada(int identificador) {
		...
		while (iterador.hasNext()) {
			...
			if (lectura == identificador) { // SI ESTÁ EN TARJETAS PERMITIDAS
...
// METODO PARA COMPROBAR LOS COCHES DEL PARKING DE LA URBANIZACIÓN 
