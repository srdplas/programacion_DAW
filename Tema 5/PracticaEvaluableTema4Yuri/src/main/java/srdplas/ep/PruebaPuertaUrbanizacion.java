...
public class PruebaPuertaUrbanizacion {
	...
	public static void main(String[] args) {
		...
		System.out.println("AÑADIMOS LAS TARJETAS DE LOS VECINOS");
		// AÑADIMOS 3/4 TARJETAS A LA PUERTA
		...
		System.out.println("\nAÑADIMOS A LA TARJETA DE PEPE Y GUARDA EL COCHE");
		p.agregaTarjetaPermitida(t2);
		p.intentoDeEntrada(222);
		p.eliminaTarjetaPermitida(222);
		//ELIMINAMOS LA TARJETA 222 DE TARJETAS PERMITIDAS Y QUITARÁ EL COCHE DE LA PLAZA DE TARJETASDENTRO
