...
public class TarjetaVideo extends Dispositivos{
    ...
    public String toString() {
        return super.toString()+ "Tarjeta de Video: marca="+getMarca()+" modelo="+getModelo()+", encendido="+isEncendido()+", Tarjeta video:cantidadNumeros="+numEntero+"cantidadTextos="+numTexto;
    }
